    ...
    return (
      <div className="flex items-center gap-3">
        <div className="hidden sm:flex flex-col items-end -space-y-1">
          <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">계정</span>
          <span className="text-xs font-medium text-zinc-600 max-w-[120px] truncate">{user.email}</span>
        </div>
